  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-slate-200 bg-white/95 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/95 transition-colors">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-3 sm:px-6 lg:px-8 gap-2">
        ...
        >
          <div className="flex h-9 w-9 sm:h-10 sm:w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-tr from-blue-600 to-cyan-500 text-white shadow-md shadow-blue-500/20">
            <BarChart3 className="h-5 w-5 sm:h-6 sm:w-6" />
          </div>
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <span className="text-sm sm:text-base font-extrabold tracking-tight text-slate-900 dark:text-white whitespace-nowrap">
                So Sánh Chi Phí <span className="text-blue-600 dark:text-blue-400">Giao Dịch</span>
              </span>
            ...
            <p className="hidden xl:block text-[11px] text-slate-500 dark:text-slate-400 whitespace-nowrap truncate max-w-[280px]">
        ...
        {/* Right actions: Theme toggle, Admin status, GitHub, CTA */}
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          {/* Admin user indicator if logged in */}
          {currentUser && (
            <div className="hidden sm:flex items-center gap-1.5 bg-emerald-50 border border-emerald-200 px-2 py-1 rounded-lg text-[11px] font-bold text-emerald-800 dark:bg-emerald-950/70 dark:border-emerald-800 dark:text-emerald-300">
          ...
          <button
            ...
            className="rounded-lg p-2 text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200 transition-colors shrink-0"
          ...
          <button
            onClick={() => scrollToSection('comparison-table')}
            className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-bold text-white shadow-sm hover:bg-blue-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition-all whitespace-nowrap shrink-0"
          >
            Mở Tài Khoản
          </button>
        </div>
