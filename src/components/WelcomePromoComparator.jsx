...
export default function WelcomePromoComparator({ companies, onSelectDetail }) {
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 transition-colors space-y-4">
      {/* Header & Description */}
      ...
      {/* Comparison Table */}
      <div className="relative rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 overflow-hidden shadow-xs">
