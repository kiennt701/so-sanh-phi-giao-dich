          ...
          <div>
            ...
            <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-850 p-2.5 space-y-1">
              <div className="text-[11px] font-bold text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                ...
                <span>Email liên hệ trực tiếp:</span>
              </div>
              <a
                href="mailto:kienhpw@gmail.com"
                className="block text-xs font-extrabold text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 truncate"
              >
                kienhpw@gmail.com
              </a>
            </div>
            ...
            <div className="mt-2.5">
              ...
              >
                <span>Hướng dẫn CONTRIBUTING.md</span>
                <ExternalLink className="h-3 w-3" />
              </a>
            </div>
          </div>
